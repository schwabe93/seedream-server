...
- **Folder workflow**: every open reference folder has a create-group action; folders with more than 10 images open a responsive picker with selection order, First 10, and Clear controls.
